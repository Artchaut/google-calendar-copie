...
<form method="post" class="flex w-full flex-col place-items-center">
	{#if form?.error}
		<div class="alert alert-warning mb-4 max-w-xs">
			<svg
...
<p>
	Vous n'avez pas de compte ? <a href="/signup" class="link link-success"
